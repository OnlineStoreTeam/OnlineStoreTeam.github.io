...
function Search({ searchClose }) {
  ...
  return (
    ...
    >
      <MenuHeader>
        <Typography component="h1" fontSize={'28px'} fontWeight={'bold'}>
          Search
        </Typography>
      ...
      {isSearchTouched && (
        <Box>
          ...
          >
            ...
            {!catalog?.length && ` Sorry, nothing found for `}"{inputValue}"
          </Box>
          ...
          {catalog?.length > 0 && (
            <StyledLink to="/search_results" onClick={showResults}>
              <Typography
                id="results"
                variant="h6"
                color="secondary.contrastText"
              ...
              <ArrowForwardOutlinedIcon
                id="results_icon"
                color="secondary.contrastText"
                sx={{ fontSize: 16, margin: 'auto 0' }}
              />
            </StyledLink>
          )}
          {!catalog?.length && (
            <StyledLink to={'/products'} onClick={backToCatalog}>
              <Typography variant="h6" color="secondary.contrastText" mr={1}>
                See all products
              </Typography>
              <ArrowForwardOutlinedIcon
                color="secondary.contrastText"
